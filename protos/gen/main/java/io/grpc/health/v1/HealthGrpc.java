...
@javax.annotation.Generated(
    ...
    comments = "Source: third_party/grpc/health/v1/HealthService.proto")
public final class HealthGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.grpc.health.v1.HealthProto.HealthCheckRequest,
      io.grpc.health.v1.HealthProto.HealthCheckResponse> getCheckMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Check",
      requestType = io.grpc.health.v1.HealthProto.HealthCheckRequest.class,
      responseType = io.grpc.health.v1.HealthProto.HealthCheckResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.grpc.health.v1.HealthProto.HealthCheckRequest,
      io.grpc.health.v1.HealthProto.HealthCheckResponse> getCheckMethod() {
    io.grpc.MethodDescriptor<io.grpc.health.v1.HealthProto.HealthCheckRequest, io.grpc.health.v1.HealthProto.HealthCheckResponse> getCheckMethod;
    if ((getCheckMethod = HealthGrpc.getCheckMethod) == null) {
      synchronized (HealthGrpc.class) {
        if ((getCheckMethod = HealthGrpc.getCheckMethod) == null) {
          HealthGrpc.getCheckMethod = getCheckMethod =
              io.grpc.MethodDescriptor.<io.grpc.health.v1.HealthProto.HealthCheckRequest, io.grpc.health.v1.HealthProto.HealthCheckResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Check"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.health.v1.HealthProto.HealthCheckRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.health.v1.HealthProto.HealthCheckResponse.getDefaultInstance()))
  ...
  public static abstract class HealthImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void check(io.grpc.health.v1.HealthProto.HealthCheckRequest request,
        io.grpc.stub.StreamObserver<io.grpc.health.v1.HealthProto.HealthCheckResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                io.grpc.health.v1.HealthProto.HealthCheckRequest,
                io.grpc.health.v1.HealthProto.HealthCheckResponse>(
                  this, METHODID_CHECK)))
          .build();
    }
  }
  ...
  public static final class HealthBlockingStub extends io.grpc.stub.AbstractBlockingStub<HealthBlockingStub> {
    ...
    /**
     */
    public io.grpc.health.v1.HealthProto.HealthCheckResponse check(io.grpc.health.v1.HealthProto.HealthCheckRequest request) {
  ...
  public static final class HealthFutureStub extends io.grpc.stub.AbstractFutureStub<HealthFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.grpc.health.v1.HealthProto.HealthCheckResponse> check(
        io.grpc.health.v1.HealthProto.HealthCheckRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CHECK:
          serviceImpl.check((io.grpc.health.v1.HealthProto.HealthCheckRequest) request,
              (io.grpc.stub.StreamObserver<io.grpc.health.v1.HealthProto.HealthCheckResponse>) responseObserver);
          break;
        default:
