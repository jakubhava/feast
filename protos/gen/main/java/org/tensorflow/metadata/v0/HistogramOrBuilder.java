...
public interface HistogramOrBuilder extends
   ...
   */
  java.util.List<org.tensorflow.metadata.v0.Histogram.Bucket> 
      getBucketsList();
  /**
   * <pre>
   * A list of buckets in the histogram, sorted from lowest bucket to highest
   ...
   * <code>repeated .tensorflow.metadata.v0.Histogram.Bucket buckets = 3;</code>
   */
  org.tensorflow.metadata.v0.Histogram.Bucket getBuckets(int index);
  /**
   * <pre>
   * A list of buckets in the histogram, sorted from lowest bucket to highest
   * bucket.
   ...
   * <code>repeated .tensorflow.metadata.v0.Histogram.Bucket buckets = 3;</code>
   */
  java.util.List<? extends org.tensorflow.metadata.v0.Histogram.BucketOrBuilder> 
   ...
   * <code>repeated .tensorflow.metadata.v0.Histogram.Bucket buckets = 3;</code>
   */
  org.tensorflow.metadata.v0.Histogram.BucketOrBuilder getBucketsOrBuilder(
      int index);
   ...
   * @return The type.
   */
  org.tensorflow.metadata.v0.Histogram.HistogramType getType();
